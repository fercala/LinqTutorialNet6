...
namespace Exercises
{
    public static class IntersectExcept
    {
        ...
        {
            return words1.Select(x => x.ToUpper()).Intersect(words2.Select(x => x.ToUpper())).Count();
        }
        ...
        {
            return numbers1.Concat(numbers2).Except(numbers1.Intersect(numbers2)).OrderBy(x => x);
        }
